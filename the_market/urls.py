...
from lecture.views import contact_us, about_us
...
# urlpatterns += static(settings.STATIC_ROOT, document_root= settings.STATIC_ROOT)
    ...
    # path('accounts/login/', LoginView.as_view(template_name='registration/login.html'),{'form_class':LoginForm}, name = 'login'),
